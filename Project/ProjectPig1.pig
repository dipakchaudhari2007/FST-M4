...
inputFile = LOAD 'hdfs:///user/dipak/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf hdfs:///user/dipak/PigProjectOutput;

-- Store the result in HDFS
STORE result INTO 'hdfs:///user/dipak/PigProjectOutput' USING PigStorage('\t');